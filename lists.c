...
/**
 * add_node_list - adds a node to the start of the list
...
list_t *add_node_list(list_t **head, const char *str, int num)
{
	...
	if (!new_head)
		return (NULL);
	_ismemset((void *)new_head, 0, sizeof(list_t));
	new_head->num = num;
	if (str)
	{
...
/**
 * add_node_end_list - adds a node to the end of the list
 * @head: address of pointer to head node
 * @str: str field of node
 * @num: node index used by history
 *
...
list_t *add_node_end_list(list_t **head, const char *str, int num)
{
	...
	if (!new_node)
		return (NULL);
	_ismemset((void *)new_node, 0, sizeof(list_t));
	new_node->num = num;
	if (str)
	{
...
/**
 * rm_node_at_index - deletes node at given index
...
/**
 * free_all_node_list - frees all nodes of a list
